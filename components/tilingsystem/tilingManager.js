...
var buildMargin = Me.imports.utils.ui.buildMargin;
var buildRectangle = Me.imports.utils.ui.buildRectangle;
var buildTileGaps = Me.imports.utils.ui.buildTileGaps;
...
var isPointInsideRect = Me.imports.utils.ui.isPointInsideRect;
var isTileOnContainerBorder = Me.imports.utils.ui.isTileOnContainerBorder;
var squaredEuclideanDistance = Me.imports.utils.ui.squaredEuclideanDistance;
var TilingLayout = Me.imports.components.tilingsystem.tilingLayout.TilingLayout;
var SnapAssist = Me.imports.components.snapassist.snapAssist.SnapAssist;
var SelectionTilePreview = Me.imports.components.tilepreview.selectionTilePreview.SelectionTilePreview;
var ActivationKey = Me.imports.settings.settings.ActivationKey;
var EdgeTilingMode = Me.imports.settings.settings.EdgeTilingMode;
...
var EdgeTilingManager = Me.imports.components.tilingsystem.edgeTilingManager.EdgeTilingManager;
var TouchPointer = Me.imports.components.tilingsystem.touchPointer.TouchPointer;
var KeyBindingsDirection = Me.imports.keybindings.KeyBindingsDirection;
var TilingShellWindowManager = Me.imports.components.windowManager.tilingShellWindowManager.TilingShellWindowManager;
var TilingLayoutWithSuggestions = Me.imports.components.windowsSuggestions.tilingLayoutWithSuggestions.TilingLayoutWithSuggestions;
var maximizeWindow = Me.imports.utils.gnomesupport.maximizeWindow;
var unmaximizeWindow = Me.imports.utils.gnomesupport.unmaximizeWindow;
var MINIMUM_DISTANCE_TO_RESTORE_ORIGINAL_SIZE = 90;

var SnapAssistingInfo = class SnapAssistingInfo {
...
var TilingManager = class TilingManager {
  ...
  openSelectionTilePreview(position, isAboveLayout, ease, window) {
    ...
    if (window)
    this._selectedTilesPreview.openAbove(window, position, ease);else
    this._selectedTilesPreview.open(position, ease);
  }
